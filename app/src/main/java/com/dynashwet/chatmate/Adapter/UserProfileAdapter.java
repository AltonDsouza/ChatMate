...
import static com.dynashwet.chatmate.R.id.progressBar;


public class UserProfileAdapter extends AAH_VideosAdapter {
    ...
    private boolean comingFromPublic;
...
//                    .getDefaultSharedPreferences(mCtx);
    ...
    public UserProfileAdapter(List<MyModel> list_urls, Picasso p, Context mCtx, boolean comingFromPublic) {
        this.list = list_urls;
        this.picasso = p;
        this.mCtx = mCtx;
        this.comingFromPublic = comingFromPublic;
    }
